			...
			<div class="page">
				...
				<div class="side_right">
					<div class="search_main">
						...
						<dl class="pic_list">
							<c:forEach var="goods" items="${goodsPageInfo.list}">
							<dd>
						...
						<div class="pageStr">
							<div class="ihuigo_page">
								<a href="${pageContext.request.contextPath}/showAllGoods/${goodsPageInfo.pageNum-1}">上一页</a>
								<c:forEach var="page_num" items="${goodsPageInfo.navigatepageNums}">
									<c:if test="${page_num == goodsPageInfo.pageNum}">
								...
								<span class="next_link"><a href="${pageContext.request.contextPath}/showAllGoods/${goodsPageInfo.pageNum+1}">下一页</a></span>
								<span class="last_link"><a href="${pageContext.request.contextPath}/showAllGoods/${goodsPageInfo.total}">尾页</a></span>
							</div>
						</div>
					</div>
				</div>
