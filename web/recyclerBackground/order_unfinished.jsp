			...
			<div id="sidebar" class="sidebar responsive ace-save-state">
				...
				<ul class="nav nav-list">
					<li class="active open">
						...
						<ul class="submenu">
							<li class="">
								<a href="${pageContext.request.contextPath}/getAllFinishOrder/1">
				...
				<div class="main-content-inner">
										...
										<table id="simple-table" class="table  table-bordered table-hover">
											<thead>
												<tr>
													...
													<th class="center col-md-1">预估总金额</th>
													...
													<th class="center col-md-1">回收状态</th>
												</tr>
											</thead>

											<tbody>
											<c:forEach items="${orderAndDetail.list}" var="order">
												<tr>
													...
													<td class="center"><a href="${pageContext.request.contextPath}/setRecycleState/${order.orderId}" style="color: red;cursor: pointer;">未处理</a></td>
												</tr>
																...
																<table id="simple-table" class="table  table-bordered table-hover">
																	<thead>
																		<tr>
																			...
																			<th class="center col-md-1" style="background-color: #ecdfdf;">预计重量</th>
																	...
																	<c:forEach items="${order.orderDetailsList}" var="orderDetails">
																		<tr>
																			...
																			<td class="center">${orderDetails["goods"].goodsPrice * orderDetails.predictWeight}</td>
																			<td class="hidden-480 center">${orderDetails.predictWeight}</td>
																			<c:choose>
																				<c:when test="${orderDetails.realWeight  != 0 }">
																					<td class="center">${orderDetails.realWeight}</td>
																				</c:when>
																				<c:otherwise>
																					<td class="center">
																						<button class="btn btn-xs btn-info" data-toggle="modal" data-target="#modal-table" onclick="get('${orderDetails.orderDetailsId}','${orderDetails["goods"].goodsName}')">
					...
					<div class="page col-md-12">
						<ul class="pagination pull-right no-margin">
							<li class="prev ">
								<a href="${pageContext.request.contextPath}/getAllOrder/${orderAndDetail.pageNum-1}">
									<i class="ace-icon fa fa-angle-double-left"></i>
								</a>
							</li>

							<c:forEach var="page_num" items="${orderAndDetail.navigatepageNums}">
								<c:if test="${page_num == orderAndDetail.pageNum}">
									<li class="active">
										<a href="#">${page_num}</a>
									</li>
								</c:if>
								<c:if test="${page_num != orderAndDetail.pageNum}">
									<li>
										<a href="${pageContext.request.contextPath}/getAllOrder/${page_num}">${page_num}</a>
									</li>
								</c:if>
							</c:forEach>
		...
		<div id="modal-table" class="modal fade" tabindex="-1">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form action="${pageContext.request.contextPath}/setRealWeight" class="form-horizontal">
						<div class="modal-body no-padding">
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">订单详情编号</label>

									<div class="col-sm-9">
										<input type="text" name="orderDetailsId" id="a1" value="" class="col-xs-10 col-sm-5" readonly/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="a2" value="" class="col-xs-10 col-sm-5" readonly/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">实际重量</label>

									<div class="col-sm-9">
										<input type="number" name="realWeight" class="col-xs-10 col-sm-5" min="1"/>
									</div>
								</div>
