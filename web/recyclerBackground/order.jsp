				...
				<ul class="nav nav-list">
					...
					<li class="active open">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="${pageContext.request.contextPath}/getAllOrder/1">
									<i class="menu-icon fa fa-caret-right"></i>
									未处理订单
								</a>
				...
				<div class="main-content-inner">
								...
								<div class="row">
									<div class="col-xs-12">
										<table id="simple-table" class="table  table-bordered table-hover">
											...
											<tbody>
											<c:forEach items="${finishOrderAndDetail.list}" var="order">
												<tr>
					...
					<div class="page col-md-12">
						<ul class="pagination pull-right no-margin">
							<li class="prev ">
								<a href="${pageContext.request.contextPath}/getAllFinishOrder/${finishOrderAndDetail.pageNum-1}">
									<i class="ace-icon fa fa-angle-double-left"></i>
								</a>
							</li>

							<c:forEach var="page_num" items="${finishOrderAndDetail.navigatepageNums}">
								<c:if test="${page_num == finishOrderAndDetail.pageNum}">
									<li class="active">
										<a href="#">${page_num}</a>
									</li>
								</c:if>
								<c:if test="${page_num != finishOrderAndDetail.pageNum}">
									<li>
										<a href="${pageContext.request.contextPath}/getAllFinishOrder/${page_num}">${page_num}</a>
									</li>
								</c:if>
							</c:forEach>
