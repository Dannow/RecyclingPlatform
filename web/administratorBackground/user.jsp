...
<div class="main-container ace-save-state" id="main-container">
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content" style="min-height: 740px;">
                ...
                <div class="page-header">
                    <h1>
                        用户表&nbsp;&nbsp;<span style="font-size: 14px;color: red;">&amp;查看</span>
                    </h1>
                </div><!-- /.page-header -->
                            ...
                            <div class="col-xs-12">
                                <table id="simple-table" class="table  table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th class="center col-md-1">电话</th>
                                        <th class="center col-md-1">地址</th>
                                        <th class="center col-md-1">总金额</th>
                                        <th class="center col-md-1">支付宝名称</th>
                                        <th class="center col-md-3">支付宝账号</th>
                                        <th class="center col-md-3">类型</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-480 center">${user.address}</td>
                                        <td class="center">${user.money}</td>
                                        <td class="hidden-480 center">${user.payName}</td>
                                        <td class="center">${user.payAccount}</td>
                                        <c:choose>
                                            <c:when test="${user.grade == 0}">
                                                <td class="center">普通用户</td>
                                            </c:when>
                                            <c:otherwise>
                                                <td class="center">回收员</td>
                                            </c:otherwise>
                                        </c:choose>
                                        <td class="center">
                                            <div class="hidden-sm hidden-xs">
                                                <button class="btn btn-xs btn-danger" onclick="window.location.href='${pageContext.request.contextPath}/deleteUser/${user.userId}'">
    ...
    <div class="page col-md-12">
        <ul class="pagination pull-right no-margin">
            <li class="prev ">
                <a href="${pageContext.request.contextPath}/showAllUser/${userList.pageNum-1}">
                    <i class="ace-icon fa fa-angle-double-left"></i>
                </a>
            </li>

            <c:forEach var="page_num" items="${userList.navigatepageNums}">
                <c:if test="${page_num == userList.pageNum}">
                    <li class="active">
                        <a href="#">${page_num}</a>
                    </li>
                </c:if>
                <c:if test="${page_num != userList.pageNum}">
                    <li>
                        <a href="${pageContext.request.contextPath}/showAllUser/${page_num}">${page_num}</a>
                    </li>
                </c:if>
            </c:forEach>
