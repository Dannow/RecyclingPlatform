			...
			<div class="page">
				...
				<div class="side_right">
					<div class="search_main">
						...
						<dl class="pic_list">
							<c:forEach var="goods" items="${goodsPageInfo1.list}">
							<dd>
						...
						<div class="pageStr">
							<div class="ihuigo_page">
								<a href="${pageContext.request.contextPath}/showAllGoods/${goodsPageInfo1.pageNum-1}">上一页</a>
								<c:forEach var="page_num" items="${goodsPageInfo1.navigatepageNums}">
									<c:if test="${page_num == goodsPageInfo1.pageNum}">
								...
								<span class="next_link"><a href="${pageContext.request.contextPath}/showAllGoods/${goodsPageInfo1.pageNum+1}">下一页</a></span>
								<span class="last_link"><a href="${pageContext.request.contextPath}/showAllGoods/${goodsPageInfo1.total}">尾页</a></span>
							</div>
						</div>
					</div>
				</div>
