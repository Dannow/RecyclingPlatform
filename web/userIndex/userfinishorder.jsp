					...
					<div class="member_r2">
						<div class="transaction">
							<dl class="transaction_title">
								<dd class="item_on2">
									<a href="../getUserOrder"><b class="item1">&nbsp;</b><em class="oo2">交易中订单</em></a>
								</dd>
								<dd class="item_on2">
									<a href="../userIndex/userfinishorder.jsp"><b class="item2">&nbsp;</b><em class="oo3">已成交订单</em></a>
								</dd>
								<div class="clear"></div>
							</dl>
							<div class="transaction_main">
								...
								<c:forEach items="${userFinishOrderDetails}" var="orderDetails">
									<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table2">
										...
										<tr>
											...
											<td width="156" style="line-height:25px;">
												<span>价格<em> ${orderDetails["goods"].goodsPrice * orderDetails.realWeight} </em>元</span>
											</td>
											<td width="178">
												<p class="table2_p"><span>交易已完成</span><br></p>
											</td>
											<td width="175">
												<span class="span3"><a href="${pageContext.request.contextPath}/deleteUserOrder/${orderDetails['order'].orderId}" >删除历史订单</a></span>
											</td>
										</tr>
										</tbody>
									</table>
