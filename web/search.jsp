	...
	<div class="page">
		...
		<div class="side_right">
			<div class="search_main">
				...
				<dl class="pic_list">
					<c:forEach var="goods" items="${searchGoodsList.list}">
						<dd>
				...
				<div class="pageStr">
					<div class="ihuigo_page">
						<a href="${pageContext.request.contextPath}/showAllGoods/${searchGoodsList.pageNum-1}">上一页</a>
						<c:forEach var="page_num" items="${searchGoodsList.navigatepageNums}">
							<c:if test="${page_num == searchGoodsList.pageNum}">
						...
						<span class="next_link"><a href="${pageContext.request.contextPath}/showAllGoods/${searchGoodsList.pageNum+1}">下一页</a></span>
						<span class="last_link"><a href="${pageContext.request.contextPath}/showAllGoods/${searchGoodsList.total}">尾页</a></span>
					</div>
				</div>
			</div>
		</div>
...
<div class="footer">
	<div class="page2">
		...
		<div class="clear"></div>
		<div class="statist">
			<p><em>Copyright Reserved 2009-2018 @</em> 深圳市绿创网络科技有限公司版权所有 <span><a href="javascript:;" target="_blank" rel="nofollow">粤ICP备10071783号</a> <script rel="nofollow" src="${pageContext.request.contextPath}/static/js/stat-4678782_4678782.js" language="JavaScript"></script>
						<script>
							var _hmt = _hmt || [];
                            (function() {
