			...
			<div class="page">
				...
				<div class="side_right">
					<div class="search_main">
						...
						<dl class="pic_list">
							<c:forEach var="goods" items="${goodsPageInfo2.list}">
							<dd>
						...
						<div class="pageStr">
							<div class="ihuigo_page">
								<a href="${pageContext.request.contextPath}/showAllGoods/${goodsPageInfo2.pageNum-1}">上一页</a>
								<c:forEach var="page_num" items="${goodsPageInfo2.navigatepageNums}">
									<c:if test="${page_num == goodsPageInfo2.pageNum}">
								...
								<span class="next_link"><a href="${pageContext.request.contextPath}/showAllGoods/${goodsPageInfo2.pageNum+1}">下一页</a></span>
								<span class="last_link"><a href="${pageContext.request.contextPath}/showAllGoods/${goodsPageInfo2.total}">尾页</a></span>
							</div>
						</div>
					</div>
				</div>
